...
static VKAPI_ATTR void VKAPI_CALL CB_vkDeviceMemoryReportCallbackEXT(
  ...
  {
    Napi::Object module = proxy->module.Value();
    Napi::Function ctor = module.Get("VkDeviceMemoryReportCallbackDataEXT").As<Napi::Function>();
    Napi::Object arg = Napi::Object::New(env);
    void* addr = const_cast<void*>(reinterpret_cast<const void*>(pCallbackData));
    arg.Set("$memoryOffset", Napi::Number::New(env, 0).As<Napi::Value>());
    arg.Set("$memoryBuffer", Napi::ArrayBuffer::New(env, addr, sizeof(VkDeviceMemoryReportCallbackDataEXT)).As<Napi::Value>());
    Napi::Object object = ctor.New({ arg });
    object.Get("reflect").As<Napi::Function>().Call(napi_value(object), { object.Get("memoryAddress").As<Napi::Value>() });
    args.push_back(object.As<Napi::Value>());
  }
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
  ...
  exports["$getVulkanEnumerations"] = Napi::Function::New(env, getVulkanEnumerations, "getVulkanEnumerations");
  {
    ...
    obj.Set("vkDeviceMemoryReportCallbackEXT", Napi::BigInt::New(env, reinterpret_cast<uint64_t>(&CB_vkDeviceMemoryReportCallbackEXT)));
  ...
  exports["vkResetQueryPool"] = Napi::Function::New(env, _vkResetQueryPool, "vkResetQueryPool");
  ...
  exports["vkCreateWin32SurfaceKHR"] = Napi::Function::New(env, _vkCreateWin32SurfaceKHR, "vkCreateWin32SurfaceKHR");
  exports["vkGetPhysicalDeviceWin32PresentationSupportKHR"] = Napi::Function::New(env, _vkGetPhysicalDeviceWin32PresentationSupportKHR, "vkGetPhysicalDeviceWin32PresentationSupportKHR");
  ...
  exports["vkGetMemoryWin32HandleNV"] = Napi::Function::New(env, _vkGetMemoryWin32HandleNV, "vkGetMemoryWin32HandleNV");
  exports["vkCmdExecuteGeneratedCommandsNV"] = Napi::Function::New(env, _vkCmdExecuteGeneratedCommandsNV, "vkCmdExecuteGeneratedCommandsNV");
  exports["vkCmdPreprocessGeneratedCommandsNV"] = Napi::Function::New(env, _vkCmdPreprocessGeneratedCommandsNV, "vkCmdPreprocessGeneratedCommandsNV");
  exports["vkCmdBindPipelineShaderGroupNV"] = Napi::Function::New(env, _vkCmdBindPipelineShaderGroupNV, "vkCmdBindPipelineShaderGroupNV");
  exports["vkGetGeneratedCommandsMemoryRequirementsNV"] = Napi::Function::New(env, _vkGetGeneratedCommandsMemoryRequirementsNV, "vkGetGeneratedCommandsMemoryRequirementsNV");
  exports["vkCreateIndirectCommandsLayoutNV"] = Napi::Function::New(env, _vkCreateIndirectCommandsLayoutNV, "vkCreateIndirectCommandsLayoutNV");
  exports["vkDestroyIndirectCommandsLayoutNV"] = Napi::Function::New(env, _vkDestroyIndirectCommandsLayoutNV, "vkDestroyIndirectCommandsLayoutNV");
  ...
  exports["vkGetMemoryWin32HandleKHR"] = Napi::Function::New(env, _vkGetMemoryWin32HandleKHR, "vkGetMemoryWin32HandleKHR");
  exports["vkGetMemoryWin32HandlePropertiesKHR"] = Napi::Function::New(env, _vkGetMemoryWin32HandlePropertiesKHR, "vkGetMemoryWin32HandlePropertiesKHR");
  ...
  exports["vkGetSemaphoreWin32HandleKHR"] = Napi::Function::New(env, _vkGetSemaphoreWin32HandleKHR, "vkGetSemaphoreWin32HandleKHR");
  exports["vkImportSemaphoreWin32HandleKHR"] = Napi::Function::New(env, _vkImportSemaphoreWin32HandleKHR, "vkImportSemaphoreWin32HandleKHR");
  ...
  exports["vkGetFenceWin32HandleKHR"] = Napi::Function::New(env, _vkGetFenceWin32HandleKHR, "vkGetFenceWin32HandleKHR");
  exports["vkImportFenceWin32HandleKHR"] = Napi::Function::New(env, _vkImportFenceWin32HandleKHR, "vkImportFenceWin32HandleKHR");
  ...
  exports["vkCreateRenderPass2"] = Napi::Function::New(env, _vkCreateRenderPass2, "vkCreateRenderPass2");
  exports["vkCmdBeginRenderPass2"] = Napi::Function::New(env, _vkCmdBeginRenderPass2, "vkCmdBeginRenderPass2");
  exports["vkCmdNextSubpass2"] = Napi::Function::New(env, _vkCmdNextSubpass2, "vkCmdNextSubpass2");
  exports["vkCmdEndRenderPass2"] = Napi::Function::New(env, _vkCmdEndRenderPass2, "vkCmdEndRenderPass2");
  exports["vkGetSemaphoreCounterValue"] = Napi::Function::New(env, _vkGetSemaphoreCounterValue, "vkGetSemaphoreCounterValue");
  exports["vkWaitSemaphores"] = Napi::Function::New(env, _vkWaitSemaphores, "vkWaitSemaphores");
  exports["vkSignalSemaphore"] = Napi::Function::New(env, _vkSignalSemaphore, "vkSignalSemaphore");
  exports["vkCmdDrawIndirectCount"] = Napi::Function::New(env, _vkCmdDrawIndirectCount, "vkCmdDrawIndirectCount");
  exports["vkCmdDrawIndexedIndirectCount"] = Napi::Function::New(env, _vkCmdDrawIndexedIndirectCount, "vkCmdDrawIndexedIndirectCount");
  ...
  exports["vkDestroyAccelerationStructureKHR"] = Napi::Function::New(env, _vkDestroyAccelerationStructureKHR, "vkDestroyAccelerationStructureKHR");
  ...
  exports["vkCmdCopyAccelerationStructureKHR"] = Napi::Function::New(env, _vkCmdCopyAccelerationStructureKHR, "vkCmdCopyAccelerationStructureKHR");
  exports["vkCopyAccelerationStructureKHR"] = Napi::Function::New(env, _vkCopyAccelerationStructureKHR, "vkCopyAccelerationStructureKHR");
  exports["vkCmdCopyAccelerationStructureToMemoryKHR"] = Napi::Function::New(env, _vkCmdCopyAccelerationStructureToMemoryKHR, "vkCmdCopyAccelerationStructureToMemoryKHR");
  exports["vkCopyAccelerationStructureToMemoryKHR"] = Napi::Function::New(env, _vkCopyAccelerationStructureToMemoryKHR, "vkCopyAccelerationStructureToMemoryKHR");
  exports["vkCmdCopyMemoryToAccelerationStructureKHR"] = Napi::Function::New(env, _vkCmdCopyMemoryToAccelerationStructureKHR, "vkCmdCopyMemoryToAccelerationStructureKHR");
  exports["vkCopyMemoryToAccelerationStructureKHR"] = Napi::Function::New(env, _vkCopyMemoryToAccelerationStructureKHR, "vkCopyMemoryToAccelerationStructureKHR");
  exports["vkCmdWriteAccelerationStructuresPropertiesKHR"] = Napi::Function::New(env, _vkCmdWriteAccelerationStructuresPropertiesKHR, "vkCmdWriteAccelerationStructuresPropertiesKHR");
  ...
  exports["vkWriteAccelerationStructuresPropertiesKHR"] = Napi::Function::New(env, _vkWriteAccelerationStructuresPropertiesKHR, "vkWriteAccelerationStructuresPropertiesKHR");
  exports["vkCmdTraceRaysKHR"] = Napi::Function::New(env, _vkCmdTraceRaysKHR, "vkCmdTraceRaysKHR");
  exports["vkCmdTraceRaysNV"] = Napi::Function::New(env, _vkCmdTraceRaysNV, "vkCmdTraceRaysNV");
  exports["vkGetRayTracingShaderGroupHandlesKHR"] = Napi::Function::New(env, _vkGetRayTracingShaderGroupHandlesKHR, "vkGetRayTracingShaderGroupHandlesKHR");
  exports["vkGetRayTracingCaptureReplayShaderGroupHandlesKHR"] = Napi::Function::New(env, _vkGetRayTracingCaptureReplayShaderGroupHandlesKHR, "vkGetRayTracingCaptureReplayShaderGroupHandlesKHR");
  ...
  exports["vkCreateRayTracingPipelinesKHR"] = Napi::Function::New(env, _vkCreateRayTracingPipelinesKHR, "vkCreateRayTracingPipelinesKHR");
  ...
  exports["vkCmdTraceRaysIndirectKHR"] = Napi::Function::New(env, _vkCmdTraceRaysIndirectKHR, "vkCmdTraceRaysIndirectKHR");
  exports["vkGetDeviceAccelerationStructureCompatibilityKHR"] = Napi::Function::New(env, _vkGetDeviceAccelerationStructureCompatibilityKHR, "vkGetDeviceAccelerationStructureCompatibilityKHR");
  exports["vkGetRayTracingShaderGroupStackSizeKHR"] = Napi::Function::New(env, _vkGetRayTracingShaderGroupStackSizeKHR, "vkGetRayTracingShaderGroupStackSizeKHR");
  exports["vkCmdSetRayTracingPipelineStackSizeKHR"] = Napi::Function::New(env, _vkCmdSetRayTracingPipelineStackSizeKHR, "vkCmdSetRayTracingPipelineStackSizeKHR");
  exports["vkGetImageViewHandleNVX"] = Napi::Function::New(env, _vkGetImageViewHandleNVX, "vkGetImageViewHandleNVX");
  exports["vkGetImageViewAddressNVX"] = Napi::Function::New(env, _vkGetImageViewAddressNVX, "vkGetImageViewAddressNVX");
  exports["vkGetPhysicalDeviceSurfacePresentModes2EXT"] = Napi::Function::New(env, _vkGetPhysicalDeviceSurfacePresentModes2EXT, "vkGetPhysicalDeviceSurfacePresentModes2EXT");
  exports["vkGetDeviceGroupSurfacePresentModes2EXT"] = Napi::Function::New(env, _vkGetDeviceGroupSurfacePresentModes2EXT, "vkGetDeviceGroupSurfacePresentModes2EXT");
  exports["vkAcquireFullScreenExclusiveModeEXT"] = Napi::Function::New(env, _vkAcquireFullScreenExclusiveModeEXT, "vkAcquireFullScreenExclusiveModeEXT");
  exports["vkReleaseFullScreenExclusiveModeEXT"] = Napi::Function::New(env, _vkReleaseFullScreenExclusiveModeEXT, "vkReleaseFullScreenExclusiveModeEXT");
  exports["vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR"] = Napi::Function::New(env, _vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR, "vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR");
  exports["vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR"] = Napi::Function::New(env, _vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR, "vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR");
  exports["vkAcquireProfilingLockKHR"] = Napi::Function::New(env, _vkAcquireProfilingLockKHR, "vkAcquireProfilingLockKHR");
  exports["vkReleaseProfilingLockKHR"] = Napi::Function::New(env, _vkReleaseProfilingLockKHR, "vkReleaseProfilingLockKHR");
  ...
  exports["vkGetBufferOpaqueCaptureAddress"] = Napi::Function::New(env, _vkGetBufferOpaqueCaptureAddress, "vkGetBufferOpaqueCaptureAddress");
  exports["vkGetBufferDeviceAddress"] = Napi::Function::New(env, _vkGetBufferDeviceAddress, "vkGetBufferDeviceAddress");
  ...
  exports["vkInitializePerformanceApiINTEL"] = Napi::Function::New(env, _vkInitializePerformanceApiINTEL, "vkInitializePerformanceApiINTEL");
  exports["vkUninitializePerformanceApiINTEL"] = Napi::Function::New(env, _vkUninitializePerformanceApiINTEL, "vkUninitializePerformanceApiINTEL");
  exports["vkCmdSetPerformanceMarkerINTEL"] = Napi::Function::New(env, _vkCmdSetPerformanceMarkerINTEL, "vkCmdSetPerformanceMarkerINTEL");
  exports["vkCmdSetPerformanceStreamMarkerINTEL"] = Napi::Function::New(env, _vkCmdSetPerformanceStreamMarkerINTEL, "vkCmdSetPerformanceStreamMarkerINTEL");
  exports["vkCmdSetPerformanceOverrideINTEL"] = Napi::Function::New(env, _vkCmdSetPerformanceOverrideINTEL, "vkCmdSetPerformanceOverrideINTEL");
  exports["vkAcquirePerformanceConfigurationINTEL"] = Napi::Function::New(env, _vkAcquirePerformanceConfigurationINTEL, "vkAcquirePerformanceConfigurationINTEL");
  exports["vkReleasePerformanceConfigurationINTEL"] = Napi::Function::New(env, _vkReleasePerformanceConfigurationINTEL, "vkReleasePerformanceConfigurationINTEL");
  exports["vkQueueSetPerformanceConfigurationINTEL"] = Napi::Function::New(env, _vkQueueSetPerformanceConfigurationINTEL, "vkQueueSetPerformanceConfigurationINTEL");
  exports["vkGetPerformanceParameterINTEL"] = Napi::Function::New(env, _vkGetPerformanceParameterINTEL, "vkGetPerformanceParameterINTEL");
  exports["vkGetDeviceMemoryOpaqueCaptureAddress"] = Napi::Function::New(env, _vkGetDeviceMemoryOpaqueCaptureAddress, "vkGetDeviceMemoryOpaqueCaptureAddress");
  exports["vkGetPipelineExecutablePropertiesKHR"] = Napi::Function::New(env, _vkGetPipelineExecutablePropertiesKHR, "vkGetPipelineExecutablePropertiesKHR");
  exports["vkGetPipelineExecutableStatisticsKHR"] = Napi::Function::New(env, _vkGetPipelineExecutableStatisticsKHR, "vkGetPipelineExecutableStatisticsKHR");
  exports["vkGetPipelineExecutableInternalRepresentationsKHR"] = Napi::Function::New(env, _vkGetPipelineExecutableInternalRepresentationsKHR, "vkGetPipelineExecutableInternalRepresentationsKHR");
  exports["vkCmdSetLineStippleEXT"] = Napi::Function::New(env, _vkCmdSetLineStippleEXT, "vkCmdSetLineStippleEXT");
  exports["vkGetPhysicalDeviceToolPropertiesEXT"] = Napi::Function::New(env, _vkGetPhysicalDeviceToolPropertiesEXT, "vkGetPhysicalDeviceToolPropertiesEXT");
  exports["vkCreateAccelerationStructureKHR"] = Napi::Function::New(env, _vkCreateAccelerationStructureKHR, "vkCreateAccelerationStructureKHR");
  exports["vkCmdBuildAccelerationStructuresKHR"] = Napi::Function::New(env, _vkCmdBuildAccelerationStructuresKHR, "vkCmdBuildAccelerationStructuresKHR");
  exports["vkCmdBuildAccelerationStructuresIndirectKHR"] = Napi::Function::New(env, _vkCmdBuildAccelerationStructuresIndirectKHR, "vkCmdBuildAccelerationStructuresIndirectKHR");
  exports["vkBuildAccelerationStructuresKHR"] = Napi::Function::New(env, _vkBuildAccelerationStructuresKHR, "vkBuildAccelerationStructuresKHR");
  exports["vkGetAccelerationStructureDeviceAddressKHR"] = Napi::Function::New(env, _vkGetAccelerationStructureDeviceAddressKHR, "vkGetAccelerationStructureDeviceAddressKHR");
  exports["vkCreateDeferredOperationKHR"] = Napi::Function::New(env, _vkCreateDeferredOperationKHR, "vkCreateDeferredOperationKHR");
  exports["vkDestroyDeferredOperationKHR"] = Napi::Function::New(env, _vkDestroyDeferredOperationKHR, "vkDestroyDeferredOperationKHR");
  exports["vkGetDeferredOperationMaxConcurrencyKHR"] = Napi::Function::New(env, _vkGetDeferredOperationMaxConcurrencyKHR, "vkGetDeferredOperationMaxConcurrencyKHR");
  exports["vkGetDeferredOperationResultKHR"] = Napi::Function::New(env, _vkGetDeferredOperationResultKHR, "vkGetDeferredOperationResultKHR");
  exports["vkDeferredOperationJoinKHR"] = Napi::Function::New(env, _vkDeferredOperationJoinKHR, "vkDeferredOperationJoinKHR");
  exports["vkCmdSetCullModeEXT"] = Napi::Function::New(env, _vkCmdSetCullModeEXT, "vkCmdSetCullModeEXT");
  exports["vkCmdSetFrontFaceEXT"] = Napi::Function::New(env, _vkCmdSetFrontFaceEXT, "vkCmdSetFrontFaceEXT");
  exports["vkCmdSetPrimitiveTopologyEXT"] = Napi::Function::New(env, _vkCmdSetPrimitiveTopologyEXT, "vkCmdSetPrimitiveTopologyEXT");
  exports["vkCmdSetViewportWithCountEXT"] = Napi::Function::New(env, _vkCmdSetViewportWithCountEXT, "vkCmdSetViewportWithCountEXT");
  exports["vkCmdSetScissorWithCountEXT"] = Napi::Function::New(env, _vkCmdSetScissorWithCountEXT, "vkCmdSetScissorWithCountEXT");
  exports["vkCmdBindVertexBuffers2EXT"] = Napi::Function::New(env, _vkCmdBindVertexBuffers2EXT, "vkCmdBindVertexBuffers2EXT");
  exports["vkCmdSetDepthTestEnableEXT"] = Napi::Function::New(env, _vkCmdSetDepthTestEnableEXT, "vkCmdSetDepthTestEnableEXT");
  exports["vkCmdSetDepthWriteEnableEXT"] = Napi::Function::New(env, _vkCmdSetDepthWriteEnableEXT, "vkCmdSetDepthWriteEnableEXT");
  exports["vkCmdSetDepthCompareOpEXT"] = Napi::Function::New(env, _vkCmdSetDepthCompareOpEXT, "vkCmdSetDepthCompareOpEXT");
  exports["vkCmdSetDepthBoundsTestEnableEXT"] = Napi::Function::New(env, _vkCmdSetDepthBoundsTestEnableEXT, "vkCmdSetDepthBoundsTestEnableEXT");
  exports["vkCmdSetStencilTestEnableEXT"] = Napi::Function::New(env, _vkCmdSetStencilTestEnableEXT, "vkCmdSetStencilTestEnableEXT");
  exports["vkCmdSetStencilOpEXT"] = Napi::Function::New(env, _vkCmdSetStencilOpEXT, "vkCmdSetStencilOpEXT");
  exports["vkCreatePrivateDataSlotEXT"] = Napi::Function::New(env, _vkCreatePrivateDataSlotEXT, "vkCreatePrivateDataSlotEXT");
  exports["vkDestroyPrivateDataSlotEXT"] = Napi::Function::New(env, _vkDestroyPrivateDataSlotEXT, "vkDestroyPrivateDataSlotEXT");
  exports["vkSetPrivateDataEXT"] = Napi::Function::New(env, _vkSetPrivateDataEXT, "vkSetPrivateDataEXT");
  exports["vkGetPrivateDataEXT"] = Napi::Function::New(env, _vkGetPrivateDataEXT, "vkGetPrivateDataEXT");
  exports["vkCmdCopyBuffer2KHR"] = Napi::Function::New(env, _vkCmdCopyBuffer2KHR, "vkCmdCopyBuffer2KHR");
  exports["vkCmdCopyImage2KHR"] = Napi::Function::New(env, _vkCmdCopyImage2KHR, "vkCmdCopyImage2KHR");
  exports["vkCmdBlitImage2KHR"] = Napi::Function::New(env, _vkCmdBlitImage2KHR, "vkCmdBlitImage2KHR");
  exports["vkCmdCopyBufferToImage2KHR"] = Napi::Function::New(env, _vkCmdCopyBufferToImage2KHR, "vkCmdCopyBufferToImage2KHR");
  exports["vkCmdCopyImageToBuffer2KHR"] = Napi::Function::New(env, _vkCmdCopyImageToBuffer2KHR, "vkCmdCopyImageToBuffer2KHR");
  exports["vkCmdResolveImage2KHR"] = Napi::Function::New(env, _vkCmdResolveImage2KHR, "vkCmdResolveImage2KHR");
  exports["vkCmdSetFragmentShadingRateKHR"] = Napi::Function::New(env, _vkCmdSetFragmentShadingRateKHR, "vkCmdSetFragmentShadingRateKHR");
  exports["vkGetPhysicalDeviceFragmentShadingRatesKHR"] = Napi::Function::New(env, _vkGetPhysicalDeviceFragmentShadingRatesKHR, "vkGetPhysicalDeviceFragmentShadingRatesKHR");
  exports["vkCmdSetFragmentShadingRateEnumNV"] = Napi::Function::New(env, _vkCmdSetFragmentShadingRateEnumNV, "vkCmdSetFragmentShadingRateEnumNV");
  exports["vkGetAccelerationStructureBuildSizesKHR"] = Napi::Function::New(env, _vkGetAccelerationStructureBuildSizesKHR, "vkGetAccelerationStructureBuildSizesKHR");
